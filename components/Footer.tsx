    ...
    <footer id='contact' className='w-full pt-20 pb-10'>
       ...
       <div className='flex flex-col items-center'>
            <h1 className='heading lg:max-w-[45vh]'>
                Ready to take <span className='text-[#d9ed92]'>your</span> digital presence to the next level?
            </h1>
       ...
       <div className='flex mt-16 md:flex-row flex-col justify-between items-center space-y-3'>
            ...
            <div className='flex items-center gap-3 '>
                {socialMedia.map((profile) => (
                    ...
                    className='w-10 h-10 cursor-pointer flex justify-center items-center backdrop-filter backdrop-blur-lg saturate-180 bg-opacity-75 bg-black-200 rounded-lg border border-white-300 hover:scale-125 transition-transform'>
