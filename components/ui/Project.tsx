...
const Project = ({  
  ...
  return (
    <div className="flex flex-col opacity-65 hover:opacity-100 hover:scale-[1.2] transition duration-500 ease-in-out border border-slate-700 rounded-3xl overflow-hidden">
      ...
      <div className="flex w-full items-center justify-between mt-7 mb-3 px-3">
        ...
        {/* Check Project */}
          <button className="border border-white/[0.2]  rounded-3xl p-2.5 hover:animate-pulse">
            <a href={link} target="_blank" className="w-full flex justify-center items-center m-0">
              <p className="flex lg:text-xl md:text-xs text-sm text-[#95d5b2] "
              >
                  Check Project
              </p>
                <FaLocationArrow className="ms-3" color="#95d5b2"/>
            </a>
          </button>          
        </div>
      </div>        
